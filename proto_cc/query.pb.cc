...
void protobuf_AssignDesc_query_2eproto() {
  ...
  static const int Answer_offsets_[2] = {
...
void protobuf_AddDesc_query_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013query.proto\022\003msg\"\'\n\005Query\022\n\n\002id\030\001 \002(\003\022"
    "\022\n\nquestioner\030\002 \002(\t\"&\n\006Answer\022\n\n\002id\030\001 \002("
    "\003\022\020\n\010answerer\030\002 \002(\t", 99);
...
Query::Query()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:msg.Query)
}
...
Query::Query(const Query& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:msg.Query)
}
...
Query::~Query() {
  // @@protoc_insertion_point(destructor:msg.Query)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:msg.Query)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:msg.Query)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:msg.Query)
  return false;
#undef DO_
}
...
void Query::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:msg.Query)
  // required int64 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:msg.Query)
}

::google::protobuf::uint8* Query::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:msg.Query)
  // required int64 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:msg.Query)
  return target;
}
...
Answer::Answer()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:msg.Answer)
}
...
Answer::Answer(const Answer& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:msg.Answer)
}
...
Answer::~Answer() {
  // @@protoc_insertion_point(destructor:msg.Answer)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:msg.Answer)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_answerer;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:msg.Answer)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:msg.Answer)
  return false;
#undef DO_
}
...
void Answer::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:msg.Answer)
  // required int64 id = 1;
  if (has_id()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(1, this->id(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:msg.Answer)
}

::google::protobuf::uint8* Answer::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:msg.Answer)
  // required int64 id = 1;
  if (has_id()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(1, this->id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:msg.Answer)
  return target;
}
